...
## Android dev12 — native text-field keyboard — 2026-09-01

- Version `1.0.1-android-dev12`, version code 11. Uses the existing signing certificate for in-place updates and retains the dev11 audio/D-pad and dev9/dev10 Turnip behavior.
