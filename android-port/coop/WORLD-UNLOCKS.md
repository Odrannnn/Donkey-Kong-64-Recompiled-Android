...
Level visits, captions, first-time actor dialogue, quit/global flags and ongoing
boss phases are not world unlocks. Paid Arcade replay (`0x083`) is synchronized
separately as explicit item ID 5896 after the lever and Arcade GB, without coin
deduction. Final K. Rool
