...
COOP_EXPORT void dk64_coop_recovery_configure_v73(uint8_t* rdram, recomp_context* ctx) {
    try {
...
COOP_EXPORT void dk64_coop_recovery_status_v73(uint8_t*, recomp_context* ctx) {
    ctx->r2 = recovery_journal.status();
}
COOP_EXPORT void dk64_coop_recovery_promote_v73(uint8_t*, recomp_context* ctx) {
...
COOP_EXPORT void dk64_coop_tick_v73(uint8_t* rdram, recomp_context* ctx) {
