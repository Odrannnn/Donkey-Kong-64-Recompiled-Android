...
COOP_EXPORT void dk64_coop_tick_v42(uint8_t* rdram, recomp_context* ctx) {
    ...
    static_assert(sizeof(ExtraInput) == 2604 && sizeof(ExtraResult) == 3300);
    ...
    try {
        ...
        // bridge and wire slots remain reserved and canonical zero in v42.
